        ...
        <template v-for="session in sessions" :key="session.sessionId">
          ...
          <tr>
            ...
            <td>
              ...
              <div v-else>
                <select
                    v-model="selectedTeacher[session.sessionId]"
            ...
            <td>
              ...
              <div v-else>
                <select
                    v-model="selectedRoomTable[session.sessionId]"
            ...
            <td>{{ session.timeSlotResponse?.name === "Morning" ? session.lessonResponse || "N/A" : "N/A" }}</td>
            <td>{{ session.timeSlotResponse?.name === "Morning" ? session.examResponse || "N/A" : "N/A" }}</td>
            <td>{{ session.timeSlotResponse?.name === "Morning" ? session.eventName || "N/A" : "N/A" }}</td>
            <td>
              <div v-if="!isEditing[session.sessionId]">
                <button @click="toggleEdit(session.sessionId)">Edit</button>
              </div>
              <div v-else>
                <button @click="toggleEdit(session.sessionId)">Done</button>
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>{{ session.timeSlotResponse?.name === "Afternoon" ? session.lessonResponse || "N/A" : "N/A" }}</td>
            <td>{{ session.timeSlotResponse?.name === "Afternoon" ? session.examResponse || "N/A" : "N/A" }}</td>
            <td>{{ session.timeSlotResponse?.name === "Afternoon" ? session.eventName || "N/A" : "N/A" }}</td>
            <td>
              <div v-if="!isEditing[session.sessionId]">
                <button @click="toggleEdit(session.sessionId)">Edit</button>
              </div>
