...
export default {
  ...
  data() {
    return {
      ...
      itemsPerPage: 5,
      students: [
        { id: 1, fullname: "Pham The Minh", rollNumber: "FA171392", japaneseName: "ファム・テ・ミン", attendance: "12/13" },
        { id: 2, fullname: "Ngo Quoc Dat", rollNumber: "FA171288", japaneseName: "", attendance: "11/13" },
        { id: 3, fullname: "Mai The Nam", rollNumber: "FA162133", japaneseName: "", attendance: "10/13" },
        { id: 4, fullname: "Hoang Thai Son", rollNumber: "FA123456", japaneseName: "", attendance: "9/13" },
        { id: 5, fullname: "Dang Hai Son", rollNumber: "FA112233", japaneseName: "", attendance: "10/13" },
        { id: 6, fullname: "Nguyen Ha Phuong", rollNumber: "FA000001", japaneseName: "", attendance: "11/13" }
      ]
    };
  },
  computed: {
  ...
  methods: {
    ...
    viewStudentDetails(studentId) {
      this.$router.push({ name: 'StudentAttendanceReport', params: { id: studentId } });
    }
