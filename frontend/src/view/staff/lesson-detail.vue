<template>
  <div class="container">
    ...
    <div class="tab-container" v-if="tabs.vocabulary">
      <p v-if="!isActive" v-html="lessonDetails.vocabulary || 'No vocabulary available'"></p>
    ...
    <div class="tab-container" v-if="tabs.kanji">
      <p v-if="!isActive" v-html="lessonDetails.kanji || 'No kạni available'"></p>
    ...
    <div class="tab-container" v-if="tabs.grammar">
      <p v-if="!isActive" v-html="lessonDetails.grammar || 'No grammar available'"></p>
