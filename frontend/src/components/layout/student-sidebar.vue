    ...
    <aside :class="`${is_expanded && 'is-expanded'}`">
        <div class="sidebar-container">
            ...
            <div class="sidebar-menu">
                <router-link class="sidebar-item" to="/student">
                ...
                <router-link class="sidebar-item" to="/student/schedule">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/class">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/curriculumn">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/holiday">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/event">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/mark">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/attendance">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/news">
                    <span class="material-icons">
                ...
                <router-link class="sidebar-item" to="/student/guide">
                    <span class="material-icons">
